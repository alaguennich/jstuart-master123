...
public class SimpleBot {
	...
	public void doMain(String[] args) throws IOException {
		...
		MChannel eclipse = bot.getChannel("eclipse", "town-square");
		MPost toSend = new MPost();
        toSend.setChannelId("zzp16ahshfgfzrgm6kobgqcgac");
		//toSend.setChannelId("gchjuhu173rafbptouh8s9w79o");
		//toSend.setChannelId("e1e004b3a5be41358495e811855148a2");
		toSend.setTeamId("86iotjfc8bdmdeq41ji99qgjja");
		toSend.setMessage("hello My Team from bot!! Can I help you ???");
		bot.sendPost(toSend);
